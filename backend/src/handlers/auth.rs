...
async fn register_user(register: web::Json<RegisterUser>, pool: web::Data<Pool>) -> HttpResponse {
...
async fn login_user(login: web::Json<LoginUser>, pool: web::Data<Pool>) -> HttpResponse {
    use schema::users::dsl::*;
